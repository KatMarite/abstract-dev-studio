        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="flex justify-center gap-6">
              {[
                { icon: Github, href: "https://github.com/KatMarite", label: "GitHub" },
                { icon: Linkedin, href: "https://www.linkedin.com/in/katleho-marite-0282867b/", label: "LinkedIn" },
                { icon: Mail, href: "mailto:katlehomarite@gmail.com", label: "Email" }
              ].map(({ icon: Icon, href, label }) => (
                <a
                  key={label}
                  href={href}
                  className="glass w-12 h-12 rounded-xl flex items-center justify-center hover-scale transition-all duration-300 group"
                  aria-label={label}
                >
