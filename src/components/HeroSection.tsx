...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-20 left-32 w-12 h-12 bg-gradient-to-br from-primary to-accent rounded-full animate-float opacity-35" style={{
      animationDelay: '1s'
    }} />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        <h1 className="text-6xl md:text-8xl font-black mb-6">
          <span className="gradient-text animate-fade-in-left bg-gradient-to-r from-primary via-tertiary to-primary bg-[length:200%_100%] animate-gradient-shift" style={{
          animationDelay: "0.2s"
        }}>Katleho</span>{" "}
          <span className="text-foreground animate-fade-in-right" style={{
          animationDelay: "0.4s"
        }}>Marite</span>
        </h1>
        
        <div className="text-2xl md:text-4xl font-bold mb-8 animate-scale-up" style={{
        animationDelay: '0.6s'
      }}>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
        ...
        }} className="btn-hero group animate-scale-up" style={{
          animationDelay: '1s'
        }}>
          ...
          <a href="/katlehocv.pdf" download="Katleho_Marite_Resume.pdf" className="btn-secondary group animate-scale-up" style={{
          animationDelay: '1.2s'
        }}>
        ...
        <div className="flex justify-center gap-6">
          {[{
          icon: Github,
          href: "https://github.com/KatMarite",
          label: "GitHub",
          delay: "1.4s"
        }, {
          icon: Linkedin,
          href: "https://www.linkedin.com/in/katleho-marite-0282867b/",
          label: "LinkedIn",
          delay: "1.6s"
        }, {
          icon: Mail,
          ...
          label,
          delay
        }) => <a key={label} href={href} className="glass w-14 h-14 rounded-2xl flex items-center justify-center hover-lift hover-glow group animate-bounce-in" style={{
      ...
      {/* Scroll Indicator */}
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce animate-fade-up" style={{
      animationDelay: '2s'
    }}>
